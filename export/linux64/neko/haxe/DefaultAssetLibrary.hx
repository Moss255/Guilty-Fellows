...
@:sound("/home/jack/haxelib/flixel/4,2,1/assets/sounds/beep.ogg") @:keep #if display private #end class __ASSET__flixel_sounds_beep_ogg extends flash.media.Sound {}
@:sound("/home/jack/haxelib/flixel/4,2,1/assets/sounds/flixel.ogg") @:keep #if display private #end class __ASSET__flixel_sounds_flixel_ogg extends flash.media.Sound {}
@:font("/home/jack/haxelib/flixel/4,2,1/assets/fonts/nokiafc22.ttf") @:keep #if display private #end class __ASSET__flixel_fonts_nokiafc22_ttf extends flash.text.Font {}
@:font("/home/jack/haxelib/flixel/4,2,1/assets/fonts/monsterrat.ttf") @:keep #if display private #end class __ASSET__flixel_fonts_monsterrat_ttf extends flash.text.Font {}
@:bitmap("/home/jack/haxelib/flixel/4,2,1/assets/images/ui/button.png") @:keep #if display private #end class __ASSET__flixel_images_ui_button_png extends flash.display.BitmapData {}
@:bitmap("/home/jack/haxelib/flixel/4,2,1/assets/images/logo/default.png") @:keep #if display private #end class __ASSET__flixel_images_logo_default_png extends flash.display.BitmapData {}



@:keep class __ASSET__assets_data_pressstart2p_ttf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/data/PressStart2P.ttf"; fontName = "Press Start 2P Regular"; }}


#else


class __ASSET__assets_data_pressstart2p_ttf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/data/PressStart2P.ttf"; fontName = "Press Start 2P Regular";  }}
...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/data/Characters.json", AssetType.TEXT);
		...
		id = "assets/data/Characters.json";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/data/PressStart2P.ttf";
		path.set (id, id);
...
@:keep #if display private #end class __ASSET__assets_data_pressstart2p_ttf extends lime.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/data/PressStart2P.ttf"; name = "Press Start 2P Regular"; super (); }}


#if (windows || mac || linux || cpp)


@:file("/home/jack/haxelib/flixel/4,2,1/assets/sounds/beep.ogg") #if display private #end class __ASSET__flixel_sounds_beep_ogg extends lime.utils.ByteArray {}
@:file("/home/jack/haxelib/flixel/4,2,1/assets/sounds/flixel.ogg") #if display private #end class __ASSET__flixel_sounds_flixel_ogg extends lime.utils.ByteArray {}
@:font("/home/jack/haxelib/flixel/4,2,1/assets/fonts/nokiafc22.ttf") #if display private #end class __ASSET__flixel_fonts_nokiafc22_ttf extends lime.text.Font {}
@:font("/home/jack/haxelib/flixel/4,2,1/assets/fonts/monsterrat.ttf") #if display private #end class __ASSET__flixel_fonts_monsterrat_ttf extends lime.text.Font {}
@:image("/home/jack/haxelib/flixel/4,2,1/assets/images/ui/button.png") #if display private #end class __ASSET__flixel_images_ui_button_png extends lime.graphics.Image {}
@:image("/home/jack/haxelib/flixel/4,2,1/assets/images/logo/default.png") #if display private #end class __ASSET__flixel_images_logo_default_png extends lime.graphics.Image {}
...
#if (openfl && !flash)
@:keep #if display private #end class __ASSET__OPENFL__assets_data_pressstart2p_ttf extends openfl.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/data/PressStart2P.ttf"; name = "Press Start 2P Regular"; super (); }}
