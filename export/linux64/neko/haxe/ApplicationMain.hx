...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Jack", "Final-GuiltyFellows", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Final - Guilty Fellows";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Final - Guilty Fellows", null, { width: 640, height: 480 });
